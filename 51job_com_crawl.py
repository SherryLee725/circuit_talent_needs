...
def get_com_id():
    conn = connection()
    cursor = conn.cursor()
    sql_str = 'SELECT * FROM `com_detail` '
...
def insert_data(job_list):
    ...
    cursor = conn.cursor()
    cursor.executemany(
        """insert into job_shortmess_com(job_id, com_id, job_effect, job_is_special, job_href, job_name, job_title, com_href,
                             com_name, job_salary, job_workarea_id, job_workarea_text, job_updatedate, com_type_text,
                             job_degreefrom, job_workyear, job_issuedate, job_welf , job_attr, com_size_text, com_ind_text)
...
def get_job_list(com_name):
    ...
    #https://search.51job.com/list/000000,000000,0000,00,9,99,{},1,1.html
    url_1 = "https://search.51job.com/list/000000,000000,0000,00,9,99,{},1,1.html".format(com_name)
    ...
    for page in range(p, page_num+1):
        ...
        url =  "https://search.51job.com/list/000000,000000,0000,00,9,99,{},1,{}.html".format(com_name,page)
        try:
