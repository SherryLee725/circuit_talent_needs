...
def insert_data(job_list):
    ...
    cursor = conn.cursor()
    cursor.executemany(
        """insert into job_shortmess_words(job_id, com_id, job_effect, job_is_special, job_href, job_name, job_title, com_href,
...
def get_job_list():
    ...
    for page in range(p, page_num + 1):
        ...
        #      https://search.51job.com/list/000000,000000,0000,00,9,99,集成电路,2,1.html
        url = "https://search.51job.com/list/020000,000000,0000,00,9,99,%E9%9B%86%E6%88%90%E7%94%B5%E8%B7%AF,2,{}.html".format(page)
        print(url)
        headers = {
